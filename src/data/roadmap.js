...
export const roadmapStageIconSlots = {
  explore: [
    { x: 490, y: 2501, rotate: -3, scale: 1.8 },
    { x: 1450, y: 3070, rotate: 2.5, scale: 2 },
    { x: 490, y: 3850, rotate: -3, scale: 1.8}
  ],
  develop: [
    { x: 420, y: 4950, rotate: -3, scale: 2 },
    { x: 1510, y: 5520, rotate: 3, scale: 1.8 },
    { x: 1580, y: 6800, rotate: 3, scale: 1.8 }
  ],
  transition: [
    { x: 490, y: 7780, rotate: -3, scale: 1.8 },
    { x: 1260, y: 8470, rotate: 3, scale: 1.85 },
    { x: 490, y: 9050, rotate: -3, scale: 1.8   }
  ]
};
